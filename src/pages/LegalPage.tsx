...
const legalContent: Record<string, { title: string; content: string[] }> = {
  privacy: {
    ...
    content: [
      ...
      "LaSean Pickens Business Solutions LLC ('we', 'us', 'our') respects your privacy and is committed to protecting your personal data.",
      ...
      "YOUR RIGHTS: You have the right to access, correct, or delete your personal data. Contact us at hello@laseanpickens.com to exercise these rights.",
      ...
      "CONTACT: For privacy inquiries, contact hello@laseanpickens.com or write to LaSean Pickens Business Solutions LLC.",
    ],
  },
  terms: {
    ...
    content: [
      "Last updated: March 1, 2026",
      "These Terms of Service govern your use of LaSean Pickens Business Solutions LLC services and website.",
      ...
      "GOVERNING LAW: These terms are governed by the laws of the state in which LaSean Pickens Business Solutions LLC is registered.",
      "CONTACT: For questions about these terms, contact hello@laseanpickens.com.",
    ],
  },
  refund: {
    title: "Refund Policy",
    content: [
      "Last updated: March 1, 2026",
      "LaSean Pickens Business Solutions LLC stands behind the quality of our services. This policy outlines our refund and cancellation procedures.",
      ...
      "HOW TO REQUEST A REFUND: Email hello@laseanpickens.com with your order number and reason for the refund request. We will respond within 2 business days.",
  ...
  cookies: {
    ...
    content: [
      "Last updated: March 1, 2026",
      "This Cookie Policy explains how LaSean Pickens Business Solutions LLC uses cookies and similar technologies.",
      ...
      "CONTACT: For questions about our cookie practices, contact hello@laseanpickens.com.",
    ],
  },
  disclaimer: {
    title: "Disclaimer",
    content: [
      ...
      "CONTACT: For questions or concerns, contact hello@laseanpickens.com.",
    ],
  },
};
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <div className="max-w-3xl mx-auto px-4 py-16">
        ...
        <div className="mt-12 pt-8 border-t border-border">
          <p className="text-xs text-muted-foreground">LaSean Pickens Business Solutions LLC - hello@laseanpickens.com</p>
        </div>
      </div>
    </div>
  );
