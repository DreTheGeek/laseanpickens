...
const resources: Resource[] = [
  { slug: "ai-automation-checklist", title: "The 10-Point AI Automation Checklist", description: "Identify your biggest automation opportunities and start saving 15+ hours per week with this actionable framework.", type: "pdf", gated: true, category: "Automation" },
  { slug: "ai-tools-guide", title: "2026 AI Tools Recommendation Guide", description: "Our curated list of the best AI tools for small-to-mid businesses, organized by use case with pricing comparisons.", type: "pdf", gated: true, category: "Technology" },
  { slug: "roi-calculator", title: "AI ROI Calculator", description: "Calculate exactly how much time and money AI automation could save your business. Interactive spreadsheet included.", type: "tool", gated: false, category: "Automation", downloadUrl: "/#roi" },
  { slug: "case-study-hvac", title: "Case Study: How an HVAC Company 10x'd Reviews", description: "Learn how we helped a mid-sized HVAC company go from 3 reviews/month to 47 using automated review collection.", type: "pdf", gated: true, category: "Case Studies" },
  ...
  { slug: "intro-to-ai-automation", title: "Introduction to AI for Business Owners", description: "A 20-minute video walkthrough explaining AI automation in plain English - no jargon, just practical applications.", type: "video", gated: false, category: "Education", downloadUrl: "#" },
